  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-lg flex-col justify-center px-6">
      ...
      <p className="mt-3 text-stone-600">
        This app reads Supabase from <strong className="font-medium">environment variables</strong> (there is no{' '}
        <code className="rounded bg-stone-200 px-1">config.ts</code> file). If you see “Failed to fetch” in the console,
        the URL or anon key is usually missing, still a placeholder, or the last deploy was built before you set env
        vars on the host.
      </p>
